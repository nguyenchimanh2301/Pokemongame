<template>
    ...
    :style="{height: `${(920-16*4)/Math.sqrt(cardContext.length)-16}px`,
    ...
    >
        <div class="card__inner" :class="{'is--flipped':isFlipped}" @click="onToggleFlipCard">
            ...
            <div class="card__content" :style="{
                backgroundSize : `${(((920-16*4)/Math.sqrt(cardContext.length)-16)*3 )/4/3}px ${(((920-16*4)/Math.sqrt(cardContext.length)-16)*3 )/4/3}px`
            }">
            </div>
            </div>
